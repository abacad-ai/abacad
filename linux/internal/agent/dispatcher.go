...
func (d *dispatcher) execute(method string, params map[string]any) (map[string]any, error) {
	...
	case "tap":
		d.x.Click(paramInt(params, "x", 0), paramInt(params, "y", 0), 1, 1, nil, paramBool(params, "humanize", false))
		return dispatched(), nil
	case "long_press":
		d.x.LongPress(paramInt(params, "x", 0), paramInt(params, "y", 0), paramInt(params, "duration_ms", 600), paramBool(params, "humanize", false))
		return dispatched(), nil
	case "swipe":
		d.x.Drag(paramInt(params, "x1", 0), paramInt(params, "y1", 0),
			paramInt(params, "x2", 0), paramInt(params, "y2", 0),
			paramInt(params, "duration_ms", 300), nil, paramBool(params, "humanize", false))
		return dispatched(), nil
	case "input_text":
	...
	case "click":
		d.x.Click(paramInt(params, "x", 0), paramInt(params, "y", 0), 1,
			paramInt(params, "count", 1), paramStrs(params, "modifiers"), paramBool(params, "humanize", false))
		return dispatched(), nil
	case "right_click":
		d.x.RightClick(paramInt(params, "x", 0), paramInt(params, "y", 0), paramBool(params, "humanize", false))
		return dispatched(), nil
	case "drag":
		d.x.Drag(paramInt(params, "x1", 0), paramInt(params, "y1", 0),
			paramInt(params, "x2", 0), paramInt(params, "y2", 0),
			paramInt(params, "duration_ms", 300), paramStrs(params, "modifiers"), paramBool(params, "humanize", false))
		return dispatched(), nil
	case "scroll":
		d.x.Scroll(paramInt(params, "x", 0), paramInt(params, "y", 0),
			paramInt(params, "dx", 0), paramInt(params, "dy", 0), paramBool(params, "humanize", false))
		return dispatched(), nil
	case "press_keys":
